...
module EX_res(
    ...
    input wire [4:0]ID_shamt_i,
    input wire [4:0]ID_reg_write_addr_i,
    input wire ID_RegWrite_i,
    input wire [1:0]ID_ALUSrc_i,
    input wire [1:0]ID_MemtoReg_i,
    input wire ID_MemWrite_i,
    input wire ID_MemRead_i,
    input wire [3:0]ID_alu_control_i,
    input wire [31:0] ID_reg_read_data1_i,
    input wire [31:0] ID_reg_read_data2_i,
    input wire [31:0]ID_pc_plus_8_i,
    input wire [4:0] ID_rs_i,
    ...
    output wire [4:0]ID_shamt_o,
    output wire [4:0]ID_reg_write_addr_o,
    output wire ID_RegWrite_o,
    output wire [1:0]ID_ALUSrc_o,
    output wire [1:0]ID_MemtoReg_o,
    output wire ID_MemWrite_o,
    output wire ID_MemRead_o,
    output wire [3:0]ID_alu_control_o,
    output wire [31:0] ID_reg_read_data1_o,
